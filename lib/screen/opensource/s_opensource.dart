...
import 'package:THECommu/common/util/local_json.dart';
import 'package:THECommu/screen/opensource/vo_package.gen.dart';
...
class _OpensourceScreenState extends State<OpensourceScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: 'opensource'.tr().text.makeWithDefaultFont(),
      ),
