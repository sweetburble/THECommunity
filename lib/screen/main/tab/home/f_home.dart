...
import 'package:THECommu/common/widget/round_button_theme.dart';
import 'package:THECommu/common/widget/w_round_button.dart';
import 'package:THECommu/screen/dialog/d_color_bottom.dart';
  ...
  void showSnackbar(BuildContext context) {
    context.showSnackbar(
      ...
      extraButton: Tap(
        ...
        child: '에러 보여주기 버튼'
            .text.white.size(13).make().centered()
            .pSymmetric(h: 10, v: 5),
      ),
      isFloating: true,
    );
