import 'package:THECommu/common/theme/color/abs_theme_colors.dart';
...
class DarkAppColors extends AbstractThemeColors {
  ...
  @override
  Color get uploadContainer => const Color(0xffEEEEEE);

  @override
  Color get blackAndWhite => const Color.fromARGB(255, 255, 255, 255);

  @override
  Color get chatCard => AppColors.darkOrange;
}
